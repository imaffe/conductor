package com.netflix.conductor.contribs.dynamicprotobufgrpc.polygot.copiedprotobuf;
...
// TODO we might not need this, as we don't need to invoke protoc at runtime
public class ProtocInvoker {
  ...
  public static ProtocInvoker forConfig(ConfigProto.ProtoConfiguration protoConfig) {
